...
def add_missing_columns(df):
    ...
    required_columns = {
        ...
        'SKU': 'no',
        'Precio oferta': 1,
        'Nombre atributo 1': 'AAA',
        'Valor atributo 1': 'BBB',
        'Nombre atributo 2': 'CCC',
        'Valor atributo 2': 'aaa',
        'Nombre atributo 3': 'bbb',
        'Valor atributo 3': 'ccc',
        'Peso': 1,
        'Alto': 1,
        'Ancho': 1,
        'Profundidad': 1,
    ...
    df['Precio oferta'] = pd.to_numeric(df['Precio'], errors='coerce')-1
